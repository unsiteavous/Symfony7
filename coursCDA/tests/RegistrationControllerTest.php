...
class RegistrationControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->userRepository = $container->get(EmployeRepository::class);
    ...
    public function testRegister(): void
    {
        ...
        self::assertEmailAddressContains($messages[0], 'from', 'automate@unsiteavous.Fr');
        ...
        self::assertTrue(static::getContainer()->get(EmployeRepository::class)->findAll()[0]->isVerified());
    }
}
