...
final class SeanceControllerTest extends WebTestCase{
    ...
    public function testIndex(): void
    {
        ...
        self::assertPageTitleContains('Liste des séances');
    ...
    public function testNew(): void
    {
        ...
        self::assertSame(11, $this->seanceRepository->count([]));

        $this->seanceRepository->delete($this->seanceRepository->find(23));
    }
